...
[CreateAssetMenu(menuName = "Custom Tiles/Platform Tile")]
public class PlatformTile : TileBase 
{
	[SerializeField]
	public Sprite[] m_Sprites;

	public Tile slope30Tile1;
	public Tile slope30Tile2;
	public Tile slope45Tile;
	...
	private bool TileValue(ITilemap tileMap, Vector3Int position)
	{
		...
		return (tile != null && (tile == this || tile == slope45Tile || tile == slope30Tile1 || tile == slope30Tile2));
	}
...
{
	private PlatformTile tile { get { return (target as PlatformTile); } }
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.Space();
		tile.slope30Tile1 = (Tile)EditorGUILayout.ObjectField("Slope 30 Tile (1)", tile.slope30Tile1, typeof(Tile), false, null);
		tile.slope30Tile2 = (Tile)EditorGUILayout.ObjectField("Slope 30 Tile (2)", tile.slope30Tile2, typeof(Tile), false, null);
		tile.slope45Tile = (Tile)EditorGUILayout.ObjectField("Slope 45 Tile", tile.slope45Tile, typeof(Tile), false, null);
